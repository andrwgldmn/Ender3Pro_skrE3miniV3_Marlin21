...
#define STRING_CONFIG_H_AUTHOR "andrwgldmn" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#if ENABLED(PID_PARAMS_PER_HOTEND)
    ...
    #define DEFAULT_Kp  11.5
    #define DEFAULT_Ki   0.57
    #define DEFAULT_Kd  57.7
  //#endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 152.5
  #define DEFAULT_bedKi 29.78
  #define DEFAULT_bedKd 520.9
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 412.8 }
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 235   // (°C) Only applies to E0 at this time
